...
RINSIDEQ=$(shell R --slave -e "cat(shQuote(paste(system.file(package='RInside'), list.files(pattern='libRInside.$(SOEXT)', path=system.file(package='RInside'), recursive=TRUE)[1], sep='/'), type='sh'))")
